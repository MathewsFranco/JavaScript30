...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"29 - Countdown Timer/scripts-START.js":[function(require,module,exports) {
var countdown;
...
var plusOneMinButton = document.querySelector('.plus-one-min');
var secondsLeft;

function timer(seconds) {
  // show the quick control buttons
  stopButton.style.display = "initial";
  plusOneMinButton.style.display = "initial"; // clear timer
  ...
  countdown = setInterval(function () {
    secondsLeft = Math.round((then - Date.now()) / 1000); // check if we should stop the count
...
function displayEndTime(timestamp) {
  ...
  endTime.textContent = "Be back at ".concat(hour, ":").concat(minutes < 10 ? "0" : "").concat(minutes);
}
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","29 - Countdown Timer/scripts-START.js"], null)
//# sourceMappingURL=/scripts-START.fe6d108c.js.map